...
public class CitiesDataController {
    ...
    public String GetPopulation(@RequestParam(value = "city") String city, @RequestParam(value = "year", required = false) Integer year){
        if(year == null){
            return dataSource.findPopulationByCity(city);
        }
